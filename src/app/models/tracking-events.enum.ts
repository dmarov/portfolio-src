export enum TrackingEvents {
  VisitRiverTvWebsiteClick = "VisitRiverTvWebsiteClick",
  VisitVmediaWebsiteClick = "VisitVmediaWebsiteClick",
  VisitPaxusWebsiteClick = "VisitPaxusWebsiteClick",
  VisitTrikWebsiteClick = "VisitTrikWebsiteClick",
